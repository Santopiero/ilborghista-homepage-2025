  ...
  return (
    <section className="relative h-[38vh] md:h-[48vh]">
      ...
      <div className="relative max-w-6xl mx-auto h-full px-4 sm:px-6 flex flex-col items-center justify-center text-center">
        ...
        {subtitle && (
          <p className="mt-2 text-white/95 text-base sm:text-lg drop-shadow">{subtitle}</p>
        )}
      </div>
    </section>
  );
    ...
    <div className="sticky top-[56px] md:top-[66px] z-40 bg-white/90 backdrop-blur border-b">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2">
        ...
        >
          ...
          <button
            type="button"
            onClick={() => { setThemesOpen((v) => !v); setPeriodOpen(false); }}
          ...
          <div className="relative shrink-0">
            <button
              type="button"
              onClick={() => { setPeriodOpen((v) => !v); setThemesOpen(false); }}
              className="inline-flex items-center gap-2 px-3 py-2 rounded-full border bg-white text-[#6B271A]"
            ...
            {periodOpen && (
              <>
                ...
                <div className="absolute mt-2 w-56 rounded-xl border bg-white shadow-xl overflow-hidden z-50">
                  {[
...
export default function Regione() {
  ...
  return (
    <main className="pb-12">
      {/* HERO */}
      <Hero image={cover} title={label} subtitle={REGION_SUBTITLE[slug]} />
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 mt-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-full border bg-white text-[#6B271A]"
          >
