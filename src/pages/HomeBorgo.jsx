  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        onClick={() => scrollBy(-1)}
        className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 z-10 h-11 w-11 items-center justify-center rounded-full bg-white shadow ring-1 ring-black/5 hover:bg-neutral-50"
      >
      ...
      <button
        ...
        onClick={() => scrollBy(1)}
        className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 z-10 h-11 w-11 items-center justify-center rounded-full bg-white shadow ring-1 ring-black/5 hover:bg-neutral-50"
      >
  ...
  return (
    <section className="relative">
      ...
      >
        ...
        <div className="absolute right-3 top-3 z-10 rounded-md bg黑/55 px-2 py-1 text-xs text-white">
          {n ? `${i + 1} / ${n}` : "1 / 1"}
        </div>
...
/* =========================
   Sezione descrizione (fade + toggle persistente per borgo)
   ========================= */
...
export default function HomeBorgo() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* PILLOLE (link a route vere; niente ancore) */}
